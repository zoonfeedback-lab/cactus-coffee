...
export default function CustomerArtHero() {
    return (
        <section className="relative flex min-h-[60vh] items-center justify-center overflow-hidden">
            {/* Background image */}
            <Image
                src="/images/hero-section pic.jfif"
                alt="Community art created by customers at Cactus Coffee"
                fill
                priority
                sizes="100vw"
                ...
                <div className="mx-auto max-w-3xl">
                    <AnimateOnScroll animation="fade-down" duration={800}>
                        <h1 className="mb-6 font-heading text-4xl font-bold leading-tight text-white sm:text-5xl md:text-6xl lg:text-7xl">
                            <span className="italic text-[#A8C5A0]">Art</span>{' '}
                            <span className="italic text-white">by Our Community</span>
                        </h1>
                    </AnimateOnScroll>
                    <AnimateOnScroll animation="fade" delay={300} duration={800}>
                        <p className="mx-auto mb-8 max-w-xl text-base leading-relaxed text-white/80 sm:text-lg">
                            Creativity lives here. Explore the beautiful artwork created by
                            our customers during workshops, open art nights, and studio sessions.
                        </p>
                    </AnimateOnScroll>
