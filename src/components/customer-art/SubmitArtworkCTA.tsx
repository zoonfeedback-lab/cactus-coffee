...
export default function SubmitArtworkCTA() {
    return (
                ...
                <AnimateOnScroll animation="fade-up" duration={700}>
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="mb-8 text-base leading-relaxed text-white/70">
                            We&apos;d love to see your work! Share your artwork with us
                            and it could be featured right here in our community gallery.
                            Or join the next session and start creating.
                        </p>
                        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                            <Link
                                href="mailto:art@cactuscoffee.com?subject=Artwork Submission"
