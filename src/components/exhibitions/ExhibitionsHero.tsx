    ...
    return (
        <section className="relative flex min-h-[45vh] items-center justify-center overflow-hidden">
            ...
            <Image
                ...
                alt="Art exhibitions at Cactus Coffee"
                fill
                priority
                sizes="100vw"
                ...
                <div className="mx-auto max-w-3xl">
                    <AnimateOnScroll animation="fade-down" duration={800}>
                        <h1 className="mb-6 font-heading text-4xl font-bold leading-tight text-white sm:text-5xl md:text-6xl lg:text-7xl">
                            <span className="italic text-[#A8C5A0]">Artist</span>{' '}
                            <span className="italic text-white">Exhibitions</span>
                        </h1>
                    </AnimateOnScroll>
                    ...
                    <AnimateOnScroll animation="fade-up" delay={600} duration={800}>
                        ...
                        >
                            <span className="relative z-10">Browse Exhibitions</span>
                        </Link>
                    </AnimateOnScroll>
                </div>
            </Container>
            ...
            <a
                href="#exhibitions"
                aria-label="Scroll to exhibitions"
